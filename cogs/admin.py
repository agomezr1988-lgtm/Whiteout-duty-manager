...
class AdminCog(commands.Cog):
    ...
    async def seed_events(self, ctx):
        ...
        Nota: esto ya se hace automáticamente al arrancar el bot,
        este comando es útil solo si has añadido eventos nuevos al
        archivo seed_events.py y quieres cargarlos sin reiniciar.
        """

        from utils.seed_loader import load_seed_events

        creados, ya_existian = load_seed_events(self.bot.get_event_manager(ctx.guild.id))
